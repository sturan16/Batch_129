...
public class MethodOverloading {
    /*
        ...
        3)Java icin "ismi" ve "parametreleri" ayni olan iki method tamamiyla aynidir.add(int a,int b)
          Bu yuzden "ismi" ve "parametre" "Method Signature" olarak adlandirilir.(insanin imzasi gibi)

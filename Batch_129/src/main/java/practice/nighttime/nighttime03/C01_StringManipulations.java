...
public class C01_StringManipulations {/*
    ...
    */
    public static void main(String[] args) {
        //Kullanicidan ismini soyismini alınız Kullanici nasıl girerse girsin
        //Tam ismini büyük harfle yazılmasını saglayan kodu yazınız
        /*Scanner input =new Scanner(System.in);
        System.out.println("Lutfen adınızı ve soyadınız giriniz");
        String adı = input.nextLine(), soyadı = input.nextLine();//Multiple declaration
        String tamIsım = adı.concat(" "+soyadı).toUpperCase();
        System.out.println("Tam isim = "+tamIsım);*/

        //Rakam haricindekileri siliniz
        String str ="$45...99";
...
//           tum karakterlerin sayisini bulan kodu yaziniz
        ...
        String str3 = "Learn Java earn 900000 money.,!... ";
        int sayıları = str3.replaceAll("[0-9]","").
                replaceAll(" ","").
                replaceAll("\\p{Punct}","").
                length();

                System.out.println(sayıları);
